...
import 'package:flutter_recipe_coach/widgets/ratting_bar.dart';
...
class _RecipePageState extends State<RecipePage> {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Stack(
          children: <Widget>[
            RecipeBodyBackground(recipe: widget.recipe),
            Positioned(
              left: 0,
              top: 0,
              bottom: 0,
              ...
              child: Scaffold(
                ...
                backgroundColor: Colors.transparent,
                body: RecipeBody(recipe: widget.recipe),
              ),
            ),
          ],
        ),
...
class RecipeBody extends StatelessWidget {
  ...
  const RecipeBody({Key key, this.recipe}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      width: double.infinity,
